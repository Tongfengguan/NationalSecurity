  ...
  <div class="terminal-container">
    <div class="terminal-window">
      ...
      <main class="terminal-body mono">
        <!-- 🚀 核心修复：移除 reveal-snappy，确保内容即时可见 -->
        <div class="log-entry">
...
.log-entry { margin-bottom: 40px; opacity: 1; }
.prompt { color: #0f0; margin-right: 15px; font-weight: bold; }
.log-content { margin-top: 15px; padding-left: 20px; border-left: 2px solid #111; color: #ddd; }
...
.terminal-list li { color: #aaa; margin-bottom: 8px; }
